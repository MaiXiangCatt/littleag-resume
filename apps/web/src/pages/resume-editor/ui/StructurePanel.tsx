  ...
  return (
    <aside className="flex h-full min-h-0 flex-col border-r border-[#e7dfe4] bg-[#f8f5f6]">
      <div className="border-b border-[#e7dfe4] px-5 py-5">
        <p className="text-[10px] font-bold uppercase tracking-[0.24em] text-[#9b568f]">
          Resume map
        </p>
      ...
      <div className="min-h-0 flex-1 overflow-y-auto p-3">
        <Button
          className={cn(
            ...
            activeId === 'profile' ? 'bg-white text-[#850477] shadow-sm' : 'text-[#62565f]',
          )}
  ...
  return (
    <div
      ...
      className={cn(
        ...
        active
          ? 'border-[#e6d7e3] bg-white text-[#850477] shadow-sm'
