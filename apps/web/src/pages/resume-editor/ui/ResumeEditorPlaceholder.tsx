...
export function ResumeEditorPlaceholder() {
  ...
  return (
    <main className="grid min-h-screen place-items-center bg-[radial-gradient(circle_at_50%_20%,rgba(191,48,30,0.08),transparent_42%),#fbfafc] px-6">
      <section className="w-full max-w-xl rounded-3xl border border-[#e7dfe8] bg-white p-8 text-center shadow-[0_24px_70px_rgba(65,37,67,0.1)] sm:p-12">
        <span className="mx-auto grid size-16 place-items-center rounded-2xl bg-[#f4e9f3] text-[#bf301e]">
          <Construction aria-hidden="true" size={30} strokeWidth={1.7} />
        </span>
        <p className="mt-6 text-xs font-semibold uppercase tracking-[0.2em] text-[#a63a2a]">
          Resume editor
        </p>
        ...
        <Button
          className="mt-7 rounded-xl bg-[#bf301e] hover:bg-[#9f2718]"
