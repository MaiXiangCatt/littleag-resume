  ...
  return (
    <header className="sticky top-0 z-30 border-b border-[#ece8ef] bg-white/95 backdrop-blur-xl">
      <div className="mx-auto flex min-h-20 max-w-[1560px] flex-wrap items-center gap-4 px-5 py-3 lg:flex-nowrap lg:px-10">
        ...
        <Label className="order-3 flex h-12 w-full cursor-text items-center gap-3 rounded-xl border border-[#ded9e2] bg-white px-4 leading-normal text-[#777080] shadow-[0_4px_16px_rgba(54,38,58,0.03)] transition focus-within:border-[#850477] focus-within:ring-4 focus-within:ring-[#850477]/8 lg:order-none lg:mx-auto lg:max-w-[440px]">
        ...
        <nav aria-label="账号操作" className="ml-auto flex shrink-0 items-center gap-1 sm:gap-2">
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button
                className="ml-1 h-auto gap-2 rounded-xl px-2 py-1.5 hover:bg-[#f8f3f8] focus-visible:ring-2 focus-visible:ring-[#850477]"
                variant="ghost"
              >
            ...
            >
              ...
              <DropdownMenuItem
                className="mt-1 gap-2 rounded-xl px-3 py-2.5 text-sm text-[#514955] focus:bg-[#f8f3f8] focus:text-[#850477]"
